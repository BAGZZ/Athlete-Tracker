...
public class AthleteTrackerDatabaseTest extends AthleteTrackerDatabase {
	...
	private InsuranceInformation insuranceInfo = new InsuranceInformation("987654321", "InsuranceCo", "1-800-555-4321", "17", "1234", "123 Bagby Ave, Zach, Colorado, 11111", new Date(1994, 12, 5), new Date(2014, 12, 5), true, 
																		  "303-555-1111", "Mom", "1-900-HO BAGZ", "123 Bagby Ave, Zach, Colorado, 11111", 10000, 1, 100000, true, "Dr. Munchkin Voice", "1-800-Lollipop Guild");
	...
	AthleteTrackerDatabaseTest(){
		...
		athletes.add((new Athlete("Munchkin", 'V', "oice", Date.valueOf("1994-4-1"), "719-330-9702", 9000001, 'M', "Freshman", "Freshman", true, "Allergies", "Medications" ,"Field Fairy", injuries, contact, insuranceInfo)));
		athletes.add((new Athlete("IceBankMic", 'e', "Elf", Date.valueOf("2000-12-25"), "719-Snt-Nick", 9000003, 'F', "Junior", "Senior", true, "Allergies", "Medications" ,"Track", injuries, contact, insuranceInfo)));
	}
